            ...
            <div class="row align-items-center h-100">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">
                        ...
                        <p>
                            Para GAM es muy importante conocer tu opinión y la experiencia que tuviste en este día de inducción, con la finalidad de mejorar nuestros servicios. <br> <br>
                    ...
                    <section class="botones">
                        <div id="separar">
                            <a style=text-decoration:none; href="../php/curso_induccion.php">
