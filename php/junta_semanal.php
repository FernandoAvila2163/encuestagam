    ...
    <div class="row">
        <div class="mx-auto">
            <div id="hijo1" class="hijos">
                <form id="formj" action="guardarJunta.php" method="POST">
                <p>¿La información previa que se te brindo acerca de esta junta semanal fue clara y oportuna (fecha, horarios, tema, liga, expositor)?</p>
                             <div class="container">
               <div class="row">
...
<!--SEGUNDA PREGUNTA-->
    <div class="row">
        <div class="mx-auto">
            ...
            <p>¿Consideras que la información y/o herramientas de esta reunión ayudan a mejorar y/o aumentar tus ventas? </p>
                    <div class="container">
               <div class="row">
                  <div class="custom-radio-button">
                     <div class="custom02">
                        <input type="radio" name="radio2" value="1" id="radio-22">
                        <label for="radio-22">Si</label>
                     </div>
                     <div class="custom02">
                        <input type="radio" name="radio2" value="2" id="radio-33">
                        <label for="radio-33">No</label>
                     </div>

                  <div>
                     <p>¿Por qué?</p>
       
                  <textarea style="width: 1500px; background-color: #2c3e50; color: white;" id="texto2"  rows="4" class="form-control" name='texto2' onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
               </div>
    ...
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo3" class="hijos">
                <p>¿Observas algo que se pueda mejorar en las reuniones de nuestras juntas semanales? Por favor, déjanos saber tu opinión:</p>
                <div class="container">
                    <div class="row">
                        <div class="custom-radio-button">
                          <textarea style="width: 1500px; background-color: #2c3e50; color: white;" id="texto3"  rows="4" class="form-control" name='texto3' onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
                        </div>
                    </div>
                </div>
                <div class="container">
    ...
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo4" class="hijos3">
               <br>
               <p>En general, ¿Cómo evalúas las juntas semanales que te brinda GAM?</p>

       <div class="container">
               <div class="row">
                  <div class="custom-radio-button">
                     <div class="custom02">
                        <input type="radio" name="radio4" value="1" id="radio-4">
                        <label for="radio-4">Muy bien</label>
                     </div>
                     <div class="custom02">
                        <input type="radio" name="radio4" value="2" id="radio-55">
                        <label for="radio-55">Regular</label>
                     </div>
                 <div class="custom02">
                        <input type="radio" name="radio4" value="2" id="radio-66">
                        <label for="radio-66">Malo</label>
                     </div>

                  <div>
                     <p>¿Por qué?</p>
       
                  <textarea style="width: 1500px; background-color: #2c3e50; color: white;" id="texto4"  rows="4" class="form-control" name='texto4' onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
               </div>
...
<!--QUINTA PREGUNTA-->
    <div class="row">
        <div class="mx-auto">
            ...
            <p>
            ¿Qué temas te gustaría que abordáramos en nuestras reuniones próximas, que te ayuden a mejorar tus ventas, crecer personalmente e ir formando tu propia empresa?</p>
                <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
                        <textarea  rows="4" class="form-control" name='texto5' onkeyup="mayus(this);" id="texto5" placeholder="Ingresa tu comentario aquí..."></textarea>
                    </div>
                </div>
             <div class="container">
                    <div class="row">
    ...
    <div class="row">
        <div class="mx-auto">
            ...
            <p>Tu opinión es muy importante, si tienes algún comentario favor de agregarlo</p>
                      <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
                        <textarea  rows="4" class="form-control" name='texto6' onkeyup="mayus(this);" id="texto1" placeholder="Ingresa tu comentario aquí..."></textarea>
                    </div>
                </div>              
                <div class="container">
                    <div class="row">
    ...
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo7" class="hijos">
                <p>¿Acerca de qué otro tema te gustaría conocer más en juntas próximas?</p>
                <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
    ...
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo8" class="hijos">
                <p>¿Hay algo que se podría mejorar en las juntas semanales? Por favor, déjanos saber tu opinión:</p>
                <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
                        <textarea class="form-control" name="P8" id="texto5" rows="4" onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
    ...
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo9" class="hijos">
                <p>En general, ¿Cómo evalúas las juntas semanales que brindamos en GAM?</p>
                <div class="feedback">
...
/*FUNCION PARA LA PREGUNTA 4*/
    function hijo5() {
        ...
        if (!document.querySelector('input[name="radio4"]:checked')) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: '¡Seleccione una respuesta de la pregunta!',
                allowOutsideClick: false //no permite que cierre la ventana a menos que se acepte una condición 
            })
            hasError = true;
