    ...
    <div class="row">
        <div class="mx-auto">
            <div id="hijo1" class="hijos">
                <form id="formP" action="guardarPlaticas.php" method="POST">
               ...
               <div class="row">
                  <div class="custom-radio-button">
                     <div class="custom02">
                        <input type="radio" name="radio1" value="1" id="radio-c11">
                        <label for="radio-c11">Si</label>
                     </div>
                     <div class="custom02">
                        <input type="radio" name="radio1" value="2" id="radio-c21">
                  ...
                  <textarea style="width: 1500px; background-color: #2c3e50; color: white;" id="texto1"  rows="4" class="form-control" name='texto1' onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
               </div>
...
<!--SEGUNDA PREGUNTA-->
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo2" class="hijos">
            <p>Considerando que 1 es la mínima y 5 la máxima en puntuación, ayúdanos a evaluar el curso de hoy en los siguientes puntos:</p> 
                ...
                <tr class="celdas">
                     ...
                     <td><input type="radio" name="radio77" value="1"></td>
                     <td><input type="radio" name="radio77" value="2"></td>
                     <td><input type="radio" name="radio77" value="3"></td>
                     <td><input type="radio" name="radio77" value="4"></td>
                     <td><input type="radio" name="radio77" value="5"></td>
                  </tr>    
                <tr class="celdas">
                     <td class="fondo1"><strong>6. </strong>Considera que el objetivo del curso se cumplió. </td>
                     <td><input type="radio" name="radio88" value="1"></td>
                     <td><input type="radio" name="radio88" value="2"></td>
                     <td><input type="radio" name="radio88" value="3"></td>
                     <td><input type="radio" name="radio88" value="4"></td>
                     <td><input type="radio" name="radio88" value="5"></td>
                  </tr>    
            </table>
               ...
               <p>Considerando que 1 es la mínima y 5 la máxima en puntuación, ayúdanos a evaluar a nuestro instructor en los siguientes puntos:</p> 
                <div class="row justify-content-center">
                  ...
                  <tr class="celdas">
                     ...
                     <td><input type="radio" name="radioP1" value="1"></td>
                     <td><input type="radio" name="radioP1" value="2"></td>
                     <td><input type="radio" name="radioP1" value="3"></td>
                     <td><input type="radio" name="radioP1" value="4"></td>
                     <td><input type="radio" name="radioP1" value="5"></td>
                  </tr>
                  <tr class="celdas">
                     <td class="fondo1"><strong>2. </strong>El instructor proyecto una imagen agradable y de confianza.</td>
                     <td><input type="radio" name="radioP2" value="1"></td>
                     <td><input type="radio" name="radioP2" value="2"></td>
                     <td><input type="radio" name="radioP2" value="3"></td>
                     <td><input type="radio" name="radioP2" value="4"></td>
                     <td><input type="radio" name="radioP2" value="5"></td>
                  </tr>
                  <tr class="celdas">
                     <td class="fondo1"><strong>3. </strong>El instructor despertó y mantuvo tu interés.</td>
                     <td><input type="radio" name="radioP3" value="1"></td>
                     <td><input type="radio" name="radioP3" value="2"></td>
                     <td><input type="radio" name="radioP3" value="3"></td>
                     <td><input type="radio" name="radioP3" value="4"></td>
                     <td><input type="radio" name="radioP3" value="5"></td>
                  </tr>
                  <tr class="celdas">
                     <td class="fondo1"><strong>4. </strong>El instructor utilizo un lenguaje apropiado y entendible para ti. </td>
                     <td><input type="radio" name="radioP4" value="1"></td>
                     <td><input type="radio" name="radioP4" value="2"></td>
                     <td><input type="radio" name="radioP4" value="3"></td>
                     <td><input type="radio" name="radioP4" value="4"></td>
                     <td><input type="radio" name="radioP4" value="5"></td>
                  </tr>     
            </table>
                <div class="container">
                    <div class="row">
...
<!--CUARTA PREGUNTA-->
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo4" class="hijos3">
                <p>¿Qué cursos te gustaría que tuviéramos en nuestro plan de capacitación, para tu desarrollo en esta carrera?</p>
                        <textarea  rows="4" class="form-control" name='texto2' onkeyup="mayus(this);" id="texto2" placeholder="Ingresa tu comentario aquí..."></textarea>
...
<!--QUINTA PREGUNTA-->
    <div class="row">
        <div class="mx-auto">
            ...
            <p>Tu opinión es muy importante, si tienes algún comentario favor de agregarlo </p>
                <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
                        <textarea  rows="4" class="form-control" name='texto3' onkeyup="mayus(this);" id="texto2" placeholder="Ingresa tu comentario aquí..."></textarea>
                    </div>
                </div>
...
<!-- SEXTA PREGUNTA -->
    <div class="row">
        <div class="mx-auto">
            ...
            <p>¿Consideras que las herramientas y conocimientos adquiridos en esta plática ayudan a mejorar el desempeño en tu actividad?</p>
            <div class="row justify-content-center">
                <div class="col-lg" style="border: 0px; background-color:transparent;">
                    <div class="select">
                        <SELECT NAME="slct3" onChange="cambioSiNo2(this)" id="slct3">
                ...
                <div id="nSi2" style="display:none;">
                </div>
                <div id="nNo2" style="display: none;">
                    <p>¿Por qué?</p>
                    <div class="row justify-content-center">
                        <div class="col-lg" style="border: 0px; background-color:transparent;">
                    <textarea rows="4" class="form-control" id="texto3" name='nNo2' onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo7" class="hijos">
                <p>¿Qué otro tema te gustaría que se abordara en las próximas pláticas?</p>
                <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
                        <textarea class="form-control" name="P7" id="texto4" rows="4" onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
                    </div>
                </div>
...
<!--OCTAVA PREGUNTA-->
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo8" class="hijos">
                <p>¿Hay algo que se podría mejorar en las futuras pláticas? Por favor, déjanos saber tu opinión:</p>
                <div class="row justify-content-center">
                    <div class="col-lg" style="border: 0px; background-color:transparent;">
                        <textarea id="texto5" class="form-control" name="P8" rows="4" onkeyup="mayus(this);" placeholder="Ingresa tu comentario aquí..."></textarea>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
...
<!-- NOVENA PREGUNTA -->
    <div class="row">
        <div class="mx-auto">
            <div style="display: none;" id="hijo9" class="hijos">
                <p>En general, ¿Cómo evalúas las pláticas que GAM les brinda a sus Agentes/Colaboradores?</p>
                <div class="feedback">
...
/*FUNCIONALIDAD PARA LOS BOTONES*/
    function hijo1() {
        ...
        document.getElementById('hijo8').style.display = "none"
        document.getElementById('hijo9').style.display = "none"
    }
...
/*FUNCION PARA LA PREGUNTA 2*/
 ...
 if (!document.querySelector('input[name="radio33"]:checked')) {
           ...
           hasError = true;
       } else if (!document.querySelector('input[name="radio77"]:checked')) {
           Swal.fire({
               icon: 'error',
               title: 'Oops...',
           ...
           hasError = true;
       } else if (!document.querySelector('input[name="radio88"]:checked')) {
           Swal.fire({
               icon: 'error',
               title: 'Oops...',
           ...
           document.getElementById('hijo6').style.display = "none"
           document.getElementById('hijo7').style.display = "none"
           $('#barra').css('width', '40.57%');
       }
   }

/*FUNCION PARA LA PREGUNTA 3*/
    function hijo4() {
       if (!document.querySelector('input[name="radioP1"]:checked')) {
           Swal.fire({
               icon: 'error',
               title: 'Oops...',
               text: '¡Seleccione una respuesta de la pregunta 1!',
           ...
           hasError = true;
       } else if (!document.querySelector('input[name="radioP2"]:checked')) {
           Swal.fire({
               icon: 'error',
               title: 'Oops...',
               text: '¡Seleccione una respuesta de la pregunta 2!',
           ...
           hasError = true;
       } else if (!document.querySelector('input[name="radioP3"]:checked')) {
           Swal.fire({
               icon: 'error',
               title: 'Oops...',
               text: '¡Seleccione una respuesta de la pregunta 3!',
           ...
           hasError = true;
       } else if (!document.querySelector('input[name="radioP4"]:checked')) {
           Swal.fire({
               icon: 'error',
               title: 'Oops...',
               text: '¡Seleccione una respuesta de la pregunta 4!',
    ...
    function hijo6() {
        ...
        if (slct2 == "seleccione") {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: '¡Seleccione alguna opción del combo!',
                allowOutsideClick: false //no permite que cierre la ventana a menos que se acepte una condición 
            })
            return false;
        } else if (texto2.length == 0 && slct2 == "no") {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
            ...
            return false;
        } else if (slct2 == "si" && texto2.length == 0) {
            document.getElementById('hijo1').style.display = "none"
            document.getElementById('hijo2').style.display = "none"
            document.getElementById('hijo3').style.display = "none"
            document.getElementById('hijo4').style.display = "none"
...
/*FUNCION PARA LA PREGUNTA 6*/
    function hijo7() {
        ...
        if (slct3 == "seleccione") {
            ...
            document.getElementById('hijo8').style.display = "none"
            document.getElementById('hijo9').style.display = "none"
            $('#barra').css('width', '66.67%');
        }
    }
/*FUNCION PARA LA PREGUNTA 7*/
    function hijo8() {
        document.getElementById('hijo1').style.display = "none"
        document.getElementById('hijo2').style.display = "none"
        document.getElementById('hijo3').style.display = "none"
        ...
        document.getElementById('hijo6').style.display = "none"
        document.getElementById('hijo7').style.display = "none"
        document.getElementById('hijo8').style.display = "block"
        document.getElementById('hijo9').style.display = "none"
        $('#barra').css('width', '95.78%');
    }

/*FUNCION PARA LA PREGUNTA 8*/
    function hijo9() {
        document.getElementById('hijo1').style.display = "none"
        document.getElementById('hijo2').style.display = "none"
        document.getElementById('hijo3').style.display = "none"
        ...
        document.getElementById('hijo7').style.display = "none"
        document.getElementById('hijo8').style.display = "none"
        document.getElementById('hijo9').style.display = "block"
        $('#barra').css('width', '88.89%');
    }
