            ...
            <div class="row align-items-center h-100">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">
                        ...
                        <p>
                            Para GAM es muy importante conocer tu opinión y la experiencia que tuviste en nuestra “Junta Semanal”, con la finalidad de mejorar nuestros servicios para tu desarrollo laboral. <br><br>
                    ...
                    <section class=botones>
                        <div id="separar">
                            <a style=text-decoration:none; href="../php/junta_semanal.php">
